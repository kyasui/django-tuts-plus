# Need to register the model with admin like below
...
class StoryAdmin(admin.ModelAdmin):
	...
	# For Django classes used in admin
	# https://docs.djangoproject.com/en/1.7/ref/contrib/admin/#modeladmin-objects
